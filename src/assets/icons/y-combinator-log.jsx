...
export const YcombinatorMark = ({ sx, color = "#838383" }) => {
  return (
    <svg
      style={{
        width: { xs: 90, md: 145 },
    ...
    >
      <g id="XMLID_70_">
        <rect id="XMLID_65_" x="0" fill={`${color}`} width="30" height="30" />
        <path
          id="XMLID_64_"
          fill="#FFFFFF"
          d="M14,17L8.8,7.3h2.4l3,6.1c0,0.1,0.1,0.2,0.2,0.3c0.1,0.1,0.1,0.2,0.2,0.4
      ...
      <g id="XMLID_72_">
        <path
          id="XMLID_74_"
          fill={`${color}`}
          d="M43.7,5.8c1.5,0,2.8,0.4,3.8,1.2l-1,1.2c-0.9-0.6-1.8-1-2.9-1c-1.7,0-3,0.9-3.7,2.6
        ...
        <path
          id="XMLID_181_"
          fill={`${color}`}
          d="M49.4,15.7c0-1.8,0.4-3.2,1.3-4.2s2-1.6,3.4-1.6c1.6,0,2.9,0.6,3.8,1.9c0.7,1,1,2.4,1,4.1
        ...
        <path
          id="XMLID_581_"
          fill={`${color}`}
          d="M62.1,13c0-1.1-0.1-2-0.4-2.7l1.7-0.4c0.3,0.5,0.4,1.1,0.4,1.6v0.1
        ...
        <path
          id="XMLID_584_"
          fill={`${color}`}
          d="M79.1,5.4L80.9,5c0.2,0.8,0.3,1.7,0.3,2.8v2.5c0,0.6,0,1,0,1.2c1-1,2.1-1.5,3.2-1.5
        ...
        <path
          id="XMLID_587_"
          fill={`${color}`}
          d="M91.3,6.8c0-0.4,0.1-0.7,0.4-1c0.3-0.3,0.6-0.4,1-0.4c0.4,0,0.7,0.1,1,0.4
        ...
        <path
          id="XMLID_596_"
          fill={`${color}`}
          d="M97.4,13c0-0.8,0-1.3-0.1-1.5c0-0.3-0.2-0.6-0.4-1.1l1.7-0.5c0.3,0.6,0.4,1.1,0.4,1.7
        ...
        <path
          id="XMLID_598_"
          fill={`${color}`}
          d="M109.5,12.6l-0.9-1.2c1.5-1,3-1.5,4.6-1.5c1.6,0,2.6,0.6,3.1,1.7c0.2,0.4,0.2,1,0.2,1.9
        ...
        <path
          id="XMLID_601_"
          fill={`${color}`}
          d="M122.2,10.2h2.8l-0.5,1.4h-2.3v7.1c0,0.6,0.1,1,0.3,1.3c0.2,0.2,0.6,0.4,1.1,0.4
        ...
        <path
          id="XMLID_603_"
          fill={`${color}`}
          d="M126.8,15.7c0-1.8,0.4-3.2,1.3-4.2c0.8-1,2-1.6,3.4-1.6c1.6,0,2.9,0.6,3.8,1.9
        ...
        <path
          id="XMLID_606_"
          fill={`${color}`}
          d="M139.6,12.8c0-1-0.1-1.8-0.4-2.4l1.7-0.5c0.3,0.6,0.4,1.1,0.4,1.7v0.2
